 ...
 */
final class Version20241024191920 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE materiau (id INT NOT NULL, title VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
